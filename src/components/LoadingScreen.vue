  ...
  <div class="hello">
    <div class="panel">
      ...
      <p class="btn-start">
        ...
        <!-- <router-link v-if="!isLoading" v-on:click="isInsert = true" to="/home" >LET'S START!</router-link> -->
        <!-- v-if="!isLoading" v-on:click="isInsert = true"-->
        <router-link v-on:click="isInsert = true" to="/home" >LET'S START!</router-link>
      </p>
    </div>
